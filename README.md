...
- ### Arrays
    ...
    - [x] Implement a vector (mutable array with automatic resizing):
        ...
        - [x] capacity() - number of items it can hold // irrelevant
        - [x] is_empty()
        ...
        - [x] resize(new_capacity) // private function // irrelevant
...
- ### Trees - Intro
    ...
    - [x] [BFS(breadth-first search) and DFS(depth-first search) (video)](https:/git/www.youtube.com/watch?v=uWL6FJhq5fM)
        - BFS notes:
...
- ### Heap / Priority Queue / Binary Heap
    ...
    - [x] [Binary trees full course](https://www.youtube.com/watch?v=fAAZixBzIAI)
        - Using this because the coursera courses were paywall gated
